      ...
      {logs.length > 0 ? (
        logs.map((log, idx) => (
          <div key={idx} className="mb-4">
            ...
            <p>
              {' '}
              <strong>Input:</strong> {log.inputTokens} tokens
            </p>
            <p>
              {' '}
              <strong>Output:</strong> {log.outputTokens} tokens
            </p>
            <p>
              {' '}
            ...
            <p>
              {' '}
              <strong>Time:</strong> {log.responseTimeMs}ms
            </p>
            <p>
              {' '}
              <strong>Context:</strong> {log.contextBreakdown}
            </p>
