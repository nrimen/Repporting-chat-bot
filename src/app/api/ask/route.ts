...
export async function POST(req: NextRequest) {
  ...
  - Si la question concerne les KPIs (CA, commandes, évolution, comparaisons, best sellers, etc.), réponds UNIQUEMENT en JSON avec cette structure :
  {
  ...
  - Si la question NE concerne PAS les KPIs, réponds UNIQUEMENT par le texte lisible suivant :
  ...
  - Ta réponse doit commencer et finir par le JSON ou par le texte d'erreur. Ne donne aucune explication avant ou après.
  `;
